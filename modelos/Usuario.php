...
Class Usuario
{
	...
	public function editar($idusuario,$nombre,$tipo_documento,$num_documento,$direccion,$telefono,$email,$cargo,$login,$clave,$imagen,$permisos)
	{
		...
		//Eliminamos todos los permisos asignados para volverlos a registrar por el id de ese usuario
	...
	public function verificar($login,$clave) // recibe los dos parametros  para determiniar si el usuario puede accer al sistema
    { // variable $sql se ejecuta mediant eel archivo conexion de la tabla usuairo la condicion es 1 osea que este activo
