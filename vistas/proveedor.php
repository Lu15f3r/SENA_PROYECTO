      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h1 class="box-title">PROVEEDOR <button class="btn btn-success" onclick="mostrarform(true)" id="btnagregar"><i
...
<input type="hidden" id="tipo_persona" name="tipo_persona" value="proveedor">
